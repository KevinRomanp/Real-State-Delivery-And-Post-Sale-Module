        ...
        area(Processing)
        {
            action(Registrar)
            {
                ...
                begin
                    ...
                    //ContractNo := rec."Contract No."; //Porque en la CU Registrar, borro este Rec
                    //AbrirHist := false;
                    CodeUnitRegistrar.Registrar(rec."No.", rec."Contract No.");
                    /*AbrirHist := Confirm(ConfirmStr, true);
                    if AbrirHist = true then begin
                        HistCabecera.Reset();
                        HistCabecera.SetRange("Contract No.", ContractNo);
                        HistCabecera.FindFirst();
                        HistCabeceraPage.RunModal(HistCabecera);
                    end
                    else
                        CurrPage.Close();*/ //TODO: descomentar
                end;
            }
